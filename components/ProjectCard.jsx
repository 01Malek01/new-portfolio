...
function ProjectCard({ projectTitle, projectDescription, projectImage, githubLink, liveLink }) {
  return (
    <div className="card bg-base-100 md:w-96 w-72 shadow-xl hover:scale-110 hover:z-10
